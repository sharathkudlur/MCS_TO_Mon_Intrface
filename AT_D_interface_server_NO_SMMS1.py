    ...
    def TRAIN_HOLD_ON(arg):
      try:
        ...
        return html + " " + L_TOM_IP
          ...
          print("Platform Number not defined in file Train Hold information")
          logs = "Platform Number not defined in file Train Hold information"
          log_file(logs)
          exit()
